...
export class PessoaService {
  ...
  protected convertDateFromClient(pessoa: IPessoa): IPessoa {
    const copy: IPessoa = Object.assign({}, pessoa, {
      dataNascimento: pessoa.dataNascimento && pessoa.dataNascimento.isValid() ? pessoa.dataNascimento.toJSON() : undefined,
      dataCadastro: pessoa.dataCadastro && pessoa.dataCadastro.isValid() ? pessoa.dataCadastro.toJSON() : undefined
    });
    return copy;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((pessoa: IPessoa) => {
        ...
        pessoa.dataCadastro = pessoa.dataCadastro ? moment(pessoa.dataCadastro) : undefined;
      });
    }
    return res;
  }
