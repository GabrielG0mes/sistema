...
import { Account } from 'app/core/operador/account.model';
...
describe('Service Tests', () => {
  describe('Account Service', () => {
    ...
    describe('identity', () => {
      it('should call /account if operador is undefined', () => {
      ...
      it('should call /account only once if not logged out after first authentication and should call /account again if operador has logged out', () => {
        // Given the operador is authenticated
        service.identity().subscribe();
      ...
      describe('navigateToStoredUrl', () => {
        it('should navigate to the previous stored url post successful authentication', () => {
          // GIVEN
          storageService.setResponse('admin/operadors?page=0');
          ...
          expect(router.navigateByUrlSpy).toHaveBeenCalledWith('admin/operadors?page=0');
        });
    ...
    describe('hasAnyAuthority', () => {
      describe('hasAnyAuthority string parameter', () => {
        it('should return false if operador is not logged', () => {
          const hasAuthority = service.hasAnyAuthority(Authority.USER);
          expect(hasAuthority).toBe(false);
        });

        it('should return false if operador is logged and has not perfil', () => {
        ...
        it('should return true if operador is logged and has perfil', () => {
          service.authenticate(accountWithAuthorities([Authority.USER]));
